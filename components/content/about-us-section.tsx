    ...
    <section className={cn("overflow-hidden bg-white py-32", className)}>
      <Container>
        <div className="relative w-full">
          <SplitSpineLayout
            gridClassName="gap-16 lg:grid-cols-[minmax(0,1fr)_440px]"
            rightClassName="flex flex-col justify-center space-y-16 border-l border-slate-100 bg-slate-50/40 px-6 md:px-8 lg:w-[440px] lg:px-10"
            left={
              <div className="space-y-8">
                <SectionHeader
                  ...
                  description={
                    <>
                      TT Medik, d.o.o. je distributer kompanije <BrandLink>ConvaTec</BrandLink>,
                      jednog od svetskih lidera u razvoju i proizvodnji inovativnih medicinskih
                      tehnologija i proizvoda koji doprinose poboljšanju kvaliteta života miliona
                      ljudi širom sveta.
                    </>
                  }
                />
                ...
                <div className="pt-2">
                  <p className="mb-8 text-lg font-bold tracking-tight text-[#00344d]">
                    <BrandLink className="font-bold">ConvaTec</BrandLink> paleta proizvoda namenjena
                    je:
                  </p>
                  ...
                  <p className="mt-10 text-lg leading-relaxed text-slate-600">
                    Mi u TT Mediku svojim velikim uspehom smatramo činjenicu da od svog osnivanja
                    1993. godine do danas, uprkos brojnim poteškoćama, pacijente u Srbiji
                    kontinuirano snabdevamo visokokvalitetnim medicinskim sredstvima. Kroz
                    svakodnevnu komunikaciju sa zdravstvenim radnicima i korisnicima naših
                    proizvoda, trudimo se da pronađemo individualno prilagođena rešenja za potrebe
                    pacijenata. Posebnu pažnju poklanjamo kontinuiranoj edukaciji svih učesnika u
                    procesu pružanja usluga zdravstvene delatnosti.
                  </p>
                </div>
              </div>
            }
