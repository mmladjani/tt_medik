...
export function PageHero({
  ...
  return (
    <section className="relative isolate min-h-[56vh] overflow-hidden border-b border-slate-200/70">
      <Image
        src={imageSrc}
        alt="TT Medik hero"
        fill
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-slate-950/72 via-slate-900/45 to-slate-900/12" />
      <div className="tt-container relative flex flex-col gap-6 py-16 text-white sm:py-20 lg:py-24">
